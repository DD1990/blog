...
layui.define(['element', 'form', 'laypage', 'jquery', 'laytpl', 'sysn'], function (exports) {
                    ...
                    .success(function (ret) {
                        ...
                        for (var i = 0; i < ret.data.length; i++) {
                            ...
                            var data = {
                                ...
                                , avatar: ret.data[i].user.avatar || '/static/image/info-img.png'
        ...
        sysn.post("/message/new", {content: content})
            .success(function (ret) {
                var view = $('#LAY-msg-tpl').html()
                    ...
                    , avatar: ret.data.user.avatar || '/static/image/info-img.png'
    ...
    //登陆
    form.on('submit(login)', function (fromdata) {console.info(22222222222)
